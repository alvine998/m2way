@extends('layouts.app', ['pageTitle' => __('app.add_user')])

@section('content')
<div class="max-w-2xl">
    <div class="bg-white rounded-xl shadow-sm border border-gray-100">
        <div class="px-6 py-4 border-b border-gray-100">
            <h2 class="text-lg font-semibold text-gray-900">{{ __('app.add_user') }}</h2>
        </div>
        <form method="POST" action="{{ route('users.store') }}" class="p-6">
            ...
            <div class="space-y-6">
                ...
                <div>
                    <label for="password" class="block text-sm font-medium text-gray-700 mb-1">{{ __('app.password') }} <span class="text-red-500">*</span></label>
                ...
                <div>
                    <label for="password_confirmation" class="block text-sm font-medium text-gray-700 mb-1">{{ __('app.confirm_password') }} <span class="text-red-500">*</span></label>
